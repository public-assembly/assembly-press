...
contract DeployAssemblyPress is Script {
...
// $ source .env
// $ forge script script/DeployAssemblyPress.s.sol:DeployAssemblyPress --rpc-url $GOERLI_RPC_URL --broadcast --verify  -vvvv
// $ forge script script/DeployAssemblyPress.s.sol:DeployAssemblyPress --rpc-url $MAINNET_RPC_URL --broadcast --verify  -vvvv

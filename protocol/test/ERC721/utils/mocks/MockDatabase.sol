...
import {ERC721PressDatabaseStorageV1} from
    "../../../../src/core/token/ERC721/database/storage/ERC721PressDatabaseStorageV1.sol";
import {IERC721PressDatabase} from "../../../../src/core/token/ERC721/interfaces/IERC721PressDatabase.sol";
...
contract MockDatabase is IERC721PressDatabase, ERC721PressDatabaseStorageV1, DualOwnable {
    ...
    */
     ...
     */
    function setLogic(address targetPress, address logic, bytes memory logicInit)
        external
     ...
     */
    function setRenderer(address targetPress, address renderer, bytes memory rendererInit)
        external
        requireInitialized(targetPress)
    {
        // Request settings access from logic contract
    ...
    function storeData(address storeCaller, bytes calldata data) external requireInitialized(msg.sender) {
        ...
        emit DataStored(sender, storeCaller, storedCounter, idToData[sender][storedCounter]);
     ...
     */
    function overwriteData(address overwriteCaller, uint256[] memory tokenIds, bytes[] calldata newData)
        external
     ...
     */
    function totalMintPrice(address targetPress, address mintCaller, uint256 mintQuantity)
        external
        view
        requireInitialized(targetPress)
     ...
     */
    function canMint(address targetPress, address mintCaller, uint256 mintQuantity)
        external
        view
        requireInitialized(targetPress)
        returns (bool mintAccess)
    {
     ...
     */
    function canBurn(address targetPress, address burnCaller, uint256 tokenId)
        external
        view
        requireInitialized(targetPress)
        returns (bool burnAccess)
    {
     ...
     */
    function canEditSettings(address targetPress, address settingsCaller)
        external
        view
        requireInitialized(targetPress)
     ...
     */
    function canEditContractData(address targetPress, address dataCaller)
        external
        view
        requireInitialized(targetPress)
     ...
     */
    function canEditTokenData(address targetPress, address dataCaller, uint256 tokenId)
        external
        view
        requireInitialized(targetPress)
        returns (bool tokenAccess)
    {
     ...
     */
    function canEditPayments(address targetPress, address paymentsCaller)
        external
        view
        requireInitialized(targetPress)
     ...
     */
    function contractURI() external view requireInitialized(msg.sender) returns (string memory uri) {

...
contract ERC721PressConfig is Test {
    ...
    modifier setUpCurationStrategy() {
        ...
        bytes memory logicInit =
            abi.encode(address(mockAccessPass), initialIsPaused, initialIsTokenDataImmutable, initialRoles);
        ...
        // SETUP DATABASE INIT
        bytes memory databaseInit = abi.encode(address(logic), logicInit, address(renderer), rendererInit);

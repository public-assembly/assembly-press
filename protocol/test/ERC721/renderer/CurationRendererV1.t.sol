...
contract CurationRendererV1Test is ERC721PressConfig {
    function test_initialize() public setUpCurationStrategy {
        ...
        require(
            keccak256(bytes(contractUriImagePath)) == keccak256(bytes("ipfs://THIS_COULD_BE_CONTRACT_URI_IMAGE_PATH")),
            "contractURIImagePath not initialized correctly"
        );
    }
    ...
    function test_setContractUriImage() public setUpCurationStrategy {
        ...
        (string memory newContractUriImagePath) =
            CurationRendererV1(pressRenderer).contractUriImageInfo(address(targetPressProxy));
        require(
            keccak256(bytes(newContractUriImagePath)) == keccak256(bytes(newPath)),
            "contractUriImagePath not updated correctly"
        );
    }
    ...
    function test_getContractUri() public setUpCurationStrategy {
        ...
        require(
            keccak256(bytes(CurationRendererV1(pressRenderer).getContractURI(address(targetPressProxy))))
                == keccak256(
                    bytes(
    ...
    function test_getTokenUri() public setUpCurationStrategy {
        ...
        require(
            keccak256(bytes(CurationRendererV1(pressRenderer).getTokenURI(address(targetPressProxy), 1)))
                == keccak256(
                    bytes(
        ...
        require(
            keccak256(bytes(CurationRendererV1(pressRenderer).getTokenURI(address(targetPressProxy), 2)))
                == keccak256(
                    bytes(
                        "data:application/json;base64,"
                    )
                ),

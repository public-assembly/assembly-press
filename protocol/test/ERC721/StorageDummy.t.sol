...
contract StorageTests is Test {
    ...
    function test_storeConfig1() public {
        ...
        bytes memory encodedListing =
            abi.encode(listing.chainId, listing.tokenId, listing.listingAddress, listing.hasTokenId);
        // call store
    ...
    function test_storeConfig2() public {
        ...
        bytes memory encodedListing =
            abi.encodePacked(listing.chainId, listing.tokenId, listing.listingAddress, listing.hasTokenId);
        // call store
    ...
    function test_forLoop_storeConfig2() public {
        ...
        bytes memory encodedListing =
            abi.encodePacked(listing_1.chainId, listing_1.tokenId, listing_1.listingAddress, listing_1.hasTokenId);
        // call store
    ...
    function encodeListing(StorageDummy.Listing memory _listing) public pure returns (bytes memory) {
        return abi.encode(_listing.chainId, _listing.tokenId, _listing.listingAddress, _listing.hasTokenId);
    }

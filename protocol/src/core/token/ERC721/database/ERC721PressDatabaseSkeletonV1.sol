...
abstract contract ERC721PressDatabaseSkeletonV1 is ERC721PressDatabaseStorageV1, IERC721PressDatabase {
     ...
     */
    function initializeWithData(bytes memory databaseInit) external requireInitialized(msg.sender) {
        // Cache msg.sender
        address sender = msg.sender;

        // Data format: logic, logicInit, renderer, rendererInit
        (address logic, bytes memory logicInit, address renderer, bytes memory rendererInit) =

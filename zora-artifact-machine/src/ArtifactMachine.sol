 ...
 * @notice Initializes tokenURIs via IArtifactMachineMetadataRenderer.updateArtifact
    ...
    ReentrancyGuard 
{
    ...
    function createArtifact(
        ...
        _createArtifact(zoraDrop, mintRecipient, tokenURIs);
    ...
    function _createArtifact(
        ...
        for (uint256 i = 0; i < tokenUriArrayLength; i++) {
            ...
            IArtifactMachineMetadataRenderer(artifactMachineMetadataRenderer).updateArtifact(
                zoraDrop,
                specificTokenId,
                tokenURIs[i]
            );
